...
void getPlayerZone(float x, float y, float z, char* buffer, size_t bufferSize) {
    ...
    for (int i = 0; i < numZones; i++) {
        ...
        float zoneMinY = gSAZones[i].area[1];
        float zoneMinZ = gSAZones[i].area[2];
        float zoneMaxX = gSAZones[i].area[3];
        float zoneMaxY = gSAZones[i].area[4];
        float zoneMaxZ = gSAZones[i].area[5];
